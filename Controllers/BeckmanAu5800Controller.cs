...
namespace LIS_Middleware.Controllers
{
    ...
    public class BeckmanAu5800Controller : Controller
    {
        ...
        public async Task<IActionResult> SetQcItemsQueried([FromBody] List<Orders> orders)
        {
            ...
            LogApiCall("/AU/setQcItemsQueried", "POST", orders, response.data, response.success, response.message, startTime);
            return Ok(response);
        }
        ...
        public async Task<IActionResult> SetQcItemsResult([FromBody] QcOrderItems qcItems)
        {
            ...
            if (qcTargets.qc_item_id == null || qcTargets.lot_id == null || qcTargets.instrument_id == null)
            {
                ...
                LogApiCall("/AU/setQcItemsResult", "POST", qcItems, response.data, response.success, response.message, startTime);
                return BadRequest(response);
            }
        ...
        public async Task<IActionResult> setItemsQueried([FromBody] List<Orders> orders)
        {
            ...
            response.data = null;
            LogApiCall("/AU/setItemsQueried", "POST", orders, response.data, response.success, response.message, startTime);
            return Ok(response);
        }
        ...
        public async Task<IActionResult> UpdateSpecimenStatus(string barcode, string status)
        {
            ...
            LogApiCall($"/AU/updateStatus/{barcode}/{status}", "GET", new { barcode, status }, response.data, response.success, response.message, startTime);
            return Ok(response);
        }
        ...
        public async Task<IActionResult> UpdateSpecimenTestResult([FromBody] OrderItems orderItems)
        {
            ...
            if (specimen == null) {
                ...
                response.data = null;
                response.message = "查無醫令資料";
                LogApiCall("/AU/setItemsResult", "POST", orderItems, response.data, response.success, response.message, startTime);
                return NotFound(response);
            }
